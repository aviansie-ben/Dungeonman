...
public class NewGameFrame extends JFrame {
    ...
    public NewGameFrame(GameFrame parent) {
        ...
        reallyjoelsDadButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane
                        .showMessageDialog(
                                NewGameFrame.this,
                                "I know you might think this is a good idea, but it's really not!\nTrust me: There is no need to prove yourself!",
                                "Reallyjoel's Dad", JOptionPane.WARNING_MESSAGE);
            }
        });
        ...
        btnOk.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (veryEasyButton.isSelected()) {
                    difficulty = 0;
                    /*
                     * difficultyName = "VERY EASY"; rules = new String[] {
                    ...
                    difficulty = 5;
                    /*
                     * difficultyName = "REALLYJOEL'S DAD"; rules = new String[]
        ...
        table.setModel(new DefaultTableModel(new Object[][] { { "Magic", new Integer(0), new Integer(5) },
                { "Strength", new Integer(0), new Integer(5) }, { "Defense", new Integer(0), new Integer(5) },
                { "Agility", new Integer(0), new Integer(5) }, { "Endurance", new Integer(0), new Integer(5) },
                { "Intelligence", new Integer(0), new Integer(5) }, }, new String[] { "Stat", "Rolled", "Bonus" }) {
            private static final long serialVersionUID = 0L;
    ...
    public void rerollStats() {
        Random r = new Random();
        EntityStats rolled = new EntityStats(3 + r.nextInt(8), 3 + r.nextInt(8), 3 + r.nextInt(8), 3 + r.nextInt(8),
                3 + r.nextInt(8), 3 + r.nextInt(8), 0);
        ...
        stats = new EntityStats(race.bonusStats.getMagic() + rolled.getMagic(), race.bonusStats.getStrength()
                + rolled.getStrength(), race.bonusStats.getDefense() + rolled.getDefense(), race.bonusStats.getAgility()
                + rolled.getAgility(), race.bonusStats.getEndurance() + rolled.getEndurance(), race.bonusStats.getIntelligence()
                + rolled.getIntelligence(), race.bonusStats.getBaseMaxHp());
    }
}
