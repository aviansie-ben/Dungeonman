...
public abstract class Tile {
    ...
    /**
     * Returns a boolean representing whether or not the key placement algorithm
     * should consider this tile to be a passable tile.
     */
     ...
     * 
     * @param state The state of the tile onto which the player is attempting to
     *            climb.
