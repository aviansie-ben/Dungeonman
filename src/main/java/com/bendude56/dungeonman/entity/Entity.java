...
public abstract class Entity implements Comparable<Entity> {
    ...
    /**
     * Drops the specified {@link com.bendude56.dungeonman.item.ItemStack} at
     ...
     * use
     * {@link com.bendude56.dungeonman.GameInstance#teleport(Entity, WorldLocation)}
     * .
     * 
     * @param l
     */
    ...
    /**
     * Gets a boolean value indicating whether this entity is visible to the
     * player and should be rendered
     */
