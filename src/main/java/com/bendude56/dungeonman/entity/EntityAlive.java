...
public abstract class EntityAlive extends Entity {
    ...
    public final boolean canSee(Entity e) {
        return AIController.getDistance(getLocation(), e.getLocation()) <= viewDistance
                && AIController.checkVisibility(getLocation(), e.getLocation());
    }
     ...
     * 
     * @param damage The amount of damage that should be done to this entity.
     *            Supplying a negative damage will cause this entity to be
     *            healed.
     */
    ...
    /**
     * Adjusts incoming damage to account for the defensive capabilities of this
     * entity.
     * 
