...
public abstract class Item {
    ...
    /**
     * Gets the name that should be displayed by the specified {@link ItemStack}
     * .
     */
     ...
     * 
     * @return True if the use was successful, false otherwise. In general, this
     *         method should return the same value as that returned by
     *         {@link #canUse(ItemStack, Entity)}.
     */
    public abstract boolean onUsed(ItemStack stack, Entity e);
    
    /**
     * Executes when the player picks up the specified stack of items off of the
     * ground.
     * 
